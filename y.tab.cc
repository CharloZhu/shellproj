...
{
       0,    65,    65,    69,    70,    74,    81,    82,    86,    90,
      91,    97,   107,   117,   126,   127,   131,   134,   138,   142,
     147,   151,   152,   157,   172,   180
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREATGREAT", "AMPERSAND", "LESS", "TWOGREAT", "PIPE", "GREATAMPERSAND",
  "GREATGREATAMPERSAND", "$accept", "goal", "argument_list",
  "command_and_args", "pipe_list", "io_modifier", "io_modifier_list",
  "background_opt", "command", "commands", "argument", "command_word",
  "output", YY_NULLPTR
};
#endif
...
static const yytype_int8 yypact[] =
{
      ...
      -6,    -6,    14,    -5,    -6,    15,    -6,    16,    16,    -6,
      17,    18,    19,    20,    -6,    21,    -6,    -6,    -6,    -6,
      -6,    -6,    -6,    -6,    -6,    -6
};
...
{
       0,     0,    24,    19,     0,     7,    15,    21,     0,     4,
      20,     1,     0,    17,    22,     5,     6,     0,     0,    16,
       0,     0,     0,     0,    14,     0,    23,     3,    25,     9,
       8,    13,    10,    12,    11,    18
};
...
static const yytype_int8 yytable[] =
{
      17,    11,    18,    19,    20,    21,    10,    22,    23,    -2,
       1,     1,     2,     2,    12,     3,     3,     2,    26,    28,
      31,    32,    33,    34,    16,    30,     0,    35,     0,     0,
      14
};
...
{
       0,     1,     3,     6,    15,    17,    18,    22,    23,    25,
       6,     0,    11,    20,    22,    16,    17,     5,     7,     8,
       9,    10,    12,    13,    19,    21,     3,    24,     3,    26,
      26,     3,     3,     3,     3,     6
};
...
#line 91 "shell.y" /* yacc.c:1646  */
    ...
    Shell::_currentCommand._errFileName = new std::string((yyvsp[0].cpp_string)->c_str());
...
#line 97 "shell.y" /* yacc.c:1646  */
    ...
    Shell::_currentCommand._errFileName = new std::string((yyvsp[0].cpp_string)->c_str());
    Shell::_currentCommand._outFileName = new std::string((yyvsp[0].cpp_string)->c_str());
...
#line 117 "shell.y" /* yacc.c:1646  */
    ...
    Shell::_currentCommand._inFileName = new std::string((yyvsp[0].cpp_string)->c_str());
...
#line 157 "shell.y" /* yacc.c:1646  */
    ...
    if (strchr((yyvsp[0].cpp_string)->c_str(), '?') && !strcmp((Command::_currSimpleCommand->convert())[0], "echo")) {
      Command::_currSimpleCommand->insertArgument((yyvsp[0].cpp_string));
    } else if (strchr((yyvsp[0].cpp_string)->c_str(), '*') || strchr((yyvsp[0].cpp_string)->c_str(), '?')) {
      // printf("Got * or ? in %s\n", strdup($1->c_str()));
      expandWildcardIfNecessary((yyvsp[0].cpp_string)->data());
    } else {
      Command::_currSimpleCommand->insertArgument((yyvsp[0].cpp_string));
    }
